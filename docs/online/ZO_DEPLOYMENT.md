...
3. Against a temporary acceptance data directory, complete a real game and submit a named score. Confirm a second browser sees the score. API simulations alone do not establish that the actual game completion flow works.

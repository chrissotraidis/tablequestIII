 ...
 *   and frame time. Writes screenshots to modern/docs/smoke/<label>/.
 *
 * Usage:
 *   node modern/tools/smoke.mjs                       # dev server on :5174 (modern)
 *   node modern/tools/smoke.mjs --url http://127.0.0.1:5173 --label classic
 *   node modern/tools/smoke.mjs --file dist/modern/index.html --label dist
 *   node modern/tools/smoke.mjs --out /tmp/shots     # custom screenshot dir
 */
